...
exports.searchResult = (req, res) => {
 ...
 "${name}" AND iteminfo.category_id =(SELECT c_id FROM category WHERE category.categoryname="${category}")
ORDER BY rating DESC,price`,function(error,preResult){
    ...
    if(error){
        ...
        JOIN iteminfo ON iteminfo.item_id = testdb.item_id
        JOIN websites ON websites.websiteID = testdb.websiteID
        WHERE LOWER(REPLACE(iteminfo.item_name,' ','')) LIKE "%${SubName}%" AND iteminfo.category_id =(SELECT c_id FROM category WHERE category.categoryname="${category}")
...
exports.searchResultByRating = (req, res) => {
    ...
    JOIN iteminfo ON iteminfo.item_id = testdb.item_id
 JOIN websites ON websites.websiteID = testdb.websiteID
    WHERE LOWER(REPLACE(iteminfo.item_name,' ','')) LIKE "${name}" AND iteminfo.category_id =(SELECT c_id FROM category WHERE category.categoryname="${category}")
